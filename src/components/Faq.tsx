    ...
    <section id="faq" className="py-24 bg-white px-6 scroll-mt-28">
      <div className="max-w-3xl mx-auto">
        ...
        <motion.div 
          ...
          className="mt-12 p-8 bg-blue-900 rounded-[2rem] text-center text-white shadow-xl shadow-blue-900/20"
        >
          <p className="text-sm opacity-80 mb-2 uppercase tracking-widest font-bold">Punya pertanyaan lain?</p>
          <p className="text-xl font-bold mb-4">Hubungi WhatsApp Layanan Desa</p>
          <a 
            href="https://wa.me/6288220007296" 
            className="inline-block px-8 py-3 bg-white text-blue-900 rounded-full font-bold hover:bg-blue-50 transition-colors"
          >
            Klik Chat Admin
          </a>
        </motion.div>
